...
task.spawn(function()
	if pcall(function() loadstring(game:HttpGet('https://raw.githubusercontent.com/Empire4946/infiniteyieldplus/main/version'))() end) then
		if ver ~= Version then
			notify('u are using fork versioN????!?!?!','frick you')
		end
